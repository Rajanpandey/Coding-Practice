...
string getRoundResult(char winning_suit, char suit1, int number1, char suit2, int number2) {
    if(suit1 == winning_suit && suit2 != winning_suit) { return "Player 1 wins"; }
    if(suit2 == winning_suit && suit1 != winning_suit) { return "Player 2 wins"; }
    return (number1 == number2) ? "Draw" : ((number1 > number2) ? "Player 1 wins" : "Player 2 wins");
}
